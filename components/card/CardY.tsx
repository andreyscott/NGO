...
const CardB = () => {
    return (
        <div className="h-full w-screen py-32">
        <div className="relative overflow-hidden rounded-lg mx-auto shadow-lg max-w-5xl h-96 md:h-[26rem] xl:h-[27rem] cursor-pointer">
          ...
          <div className="absolute top-0 text-left font-serif left-0 px-6 py-8">
           ...
           <RiDoubleQuotesR
           className='text-[90px] text-white mr-2'
           />
                </h4>
            ...
            className="leading-normal text-lg md:text-xl text-gray-100">
                ...
                <div className="flex text-left justify-start my-4 w-fit transition-all duration-1000 ease-out">
