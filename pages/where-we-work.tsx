    ...
    return (
        <ClientLayout >
           ...
           {/* one Lager Image Section */}
            <div className="w-full max-w-5xl h-[700px] lg:max-w-6xl px-2 lg:px-6 py-16 lg:py-28 relative mx-auto">
                <Image
            ...
            className="text-4xl leading-[50px] font-normal tracking-wider text-[#262533] sm:text-4xl">
